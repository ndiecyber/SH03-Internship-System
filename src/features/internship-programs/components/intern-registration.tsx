...
import { Briefcase, Link as LinkIcon, Send, X, CheckCircle, Clock, AlertTriangle, HelpCircle } from "lucide-react";
import { applyForProgramAction } from "../services/application.actions";
