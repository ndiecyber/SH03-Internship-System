...
import { Megaphone, Globe, Users, Calendar, Clock, Link2 } from "lucide-react";

export const metadata = createPageMetadata("Announcements");

export default async function InternAnnouncementsPage() {
  const items = await getPublishedAnnouncements("INTERN");
              ...
              <div className="flex items-start gap-3">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  {(item.eventDate || item.eventTime || item.meetLink) && (
                    <div className="mt-3 flex flex-wrap items-center gap-3 rounded-lg bg-blue-50 border border-blue-100 px-3 py-2">
                      {item.eventDate && (
